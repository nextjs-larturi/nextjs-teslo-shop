...
const columns: GridColDef[] = [
   ...
   },
   {
      ...
      renderCell: ({ row }: GridRenderCellParams) => {
         if (row.gender[0] === 'kid')
            return <Chip variant='outlined' label='Kid' color='success' />;
         if (row.gender[0] === 'unisex')
            return <Chip variant='outlined' label='Unisex' color='error' />;
         if (row.gender[0] === 'women')
            return <Chip variant='outlined' label='Women' color='warning' />;
         if (row.gender[0] === 'men')
            return <Chip variant='outlined' label='Men' color='primary' />;
      },
   },
